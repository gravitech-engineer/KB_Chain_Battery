...
KB_BATTERY::KB_BATTERY(uint8_t adcAddress, int adcVRef) {
...
int KB_BATTERY::readI2CADC(void) {
...
float KB_BATTERY::calcMillivolts() {
...
float KB_BATTERY::calcMillivolts(int rawADC) {
...
*/
/////////////////////////////////////////////////////////////////////////////
void KB_BATTERY::updateVRef(int adcVRef)
{
  _adcVRef = adcVRef;
}
